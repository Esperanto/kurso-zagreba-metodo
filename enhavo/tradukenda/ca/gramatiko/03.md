...
*Per* (amb el sentit "mitjançant"), indica mitjà o instrument i va amb noms d'objectes.
...
- *grand__ul__o*	– un ganàpia, una persona gran (alta o voluminosa)
...
- *vid__ebl__a*     – visible
- *kompren__ebl__e* – comprensiblement, lògicament, per descomptat
