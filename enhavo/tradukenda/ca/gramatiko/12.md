...
A) Els numerals col·lectius es formen amb el sufix __-OP__. Aquest sufix de vegades es pot elidir en els substantius:
...
B) Les fraccions es formen amb __-ON__, que també permet derivar adjectius i adverbis:
- *du__on__o* – la meitat
- *du__on__a* – mig/mitja
- *du__on__e* – a mitges
- *tri__on__o* – un terç
...
C) Els múltiples es formen amb el sufix __-OBL__, igualment susceptible d'esdevenir adjectiu o adverbi:
- *du__obl__o* – El doble
