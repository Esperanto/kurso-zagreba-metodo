...
- __ĝ__ = como en inglés "__g__enius".
- __h__ = hache aspirada.
- __ĥ__ = "j".
- __j__ = "y" en "hoy", "i" n "pierna" o en "reino".
- 	  Es una semiconsonante y semivocal para formar diptongos: kaj ("casi"), jes ("ies").
- __ĵ__ = como en francés "bon__j__our"
- __r__ = las dos __r__ de __r__ive__r__o se pronuncian igual.
- __ŝ__ = como en inglés "__Sh__akespeare".
- __ŭ__ = "u" en "Europa", "auto", "piedo", "cuatro".
- 	  Es una semiconsonante y semivocal para formar diptongos: Eŭropo ("europo"), aŭtoro.
- __v__ = "v" francesa, catalana.
- __z__ = "s" sonora; como la "z" en inglés.
...
La palabra __ĉu__ al principio de una oración la hace interrogativa. Puede traducirse por "¿Acaso...?", "¿Es que..." o no traducirse.
...
Indica "profesional, persona ocupada en algo habitualmente".
...
Indica el sexo femenino (recuérdese que gramaticalmente todos los sustantivos son neutros y terminan en -O).
