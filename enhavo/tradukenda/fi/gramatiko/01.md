...
- *a* = lyhyt, selkeä a
- *c* = ts, kuten sanan "tsaari" alussa tai sanassa "itse"
- *ĉ* = tš, kuten "tšekki"
...
- *i* = lyhyt i
- *j* = suomen j, mutta vokaalin jäljessä se toimii lyhyenä i-liukuna. Yhdistelmät *aj, ej, oj, uj* ovat diftongeja; *oj* on erityisen yleinen monikossa, esimerkiksi *tabloj*
- *ĵ* = ž, soinnillinen š
- *o* = lyhyt o
...
- _via**j** lernanto**j**_ - sinun oppijasi (useat oppijat) / teidän oppijanne
