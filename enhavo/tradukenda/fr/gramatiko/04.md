...
L'espéranto indique un mouvement vers une destination (vers où ?) avec la terminaison de l'accusatif *__-n__*. Dans ce cas, l'accusatif s'emploie même après une préposition. Exception logique : *al*, *ĝis*, *tra* (à/vers, jusqu'à, à travers) indiquent déjà la direction.
