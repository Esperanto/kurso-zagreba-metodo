...
- _**o**_ = *o* eller *å*
- _**r**_ blir uttala alltid, helst rulla eller tappa
...
**💡 Hugsetips:** Eigedomspronomen = personleg pronomen + _**-a**_: *mi* (eg) → *mia* (min/mitt), *vi* (du/de) → *via* (din/ditt/dykkar).
...
- *lernanto* – elev
  - _lernant**in**o_ – kvinneleg elev
- *instruisto* – lærar
  - _instruist**in**o_ – kvinneleg lærer
