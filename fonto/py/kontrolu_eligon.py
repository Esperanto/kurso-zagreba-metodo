...
TITLE_ROOT_PATTERN = re.compile(r'<title>Esperanto in 12 Hours \| The Fastest Basics Course</title>')
META_DESCRIPTION_PATTERN = re.compile(r'<meta name="description" content="Learn the 500 most important words\. They are enough for 95% of spoken Esperanto\. Free and no sign-up\.')
...
OG_DESCRIPTION_PATTERN = re.compile(r'<meta property="og:description" content="Learn the 500 most important words\. They are enough for 95% of spoken Esperanto\. Free and no sign-up\.')
...
LLMS_EN_DUPLICATE_INTRO_PATTERN = re.compile(
    r'\(https://esperanto12\.net/en/\): Learn the 500 most important words\.'
)
