...
TITLE_ROOT_PATTERN = re.compile(r'<title>Learn Esperanto in 12 Hours \| The Fastest Basics Course</title>')
META_DESCRIPTION_PATTERN = re.compile(r'<meta name="description" content="Learn the 500 most important words\. Understand 95 % of spoken Esperanto\. Free and no sign-up\.')
